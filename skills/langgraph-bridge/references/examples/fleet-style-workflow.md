...
**Workflow authors:** see [`docs/phase-event-contract.md`](../../../../docs/phase-event-contract.md) for the full payload schema, worked examples, and the `emit_phase_event` Python helper (which derives `kind`/`title` for you).
